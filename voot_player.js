...
<meta charset="utf-8">
  ...
  <title>VOOT Online Player and Downloader !!</title>
...
<body>
  <h1 style="color:orange; text-align:center; cursor: pointer;"><a href="https://voot.connectvip.workers.dev">VOOT HLS Streamer </a></h1>
...
<br><br><h3 style="text-align: center; color: #FFB200; font-family: 'Balsamiq Sans', cursive; font-size: 17px;">👇 Enter Your VOOT URL or VIDEO ID Below 👇 <br>And Click On STREAM</h3><br><br><br>
  <div><form method="get"  action="https://voot.connectvip.workers.dev" _lpchecked="1">
  <center>
 <div class="bar">
...
<meta charset="utf-8">
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <link rel="shortcut icon" type="image/x-icon" href="https://www.voot.com/favicon.ico">
  <title>Not Found | VOOT Online Player and Downloader !!</title>
  <link rel="stylesheet" href="https://avipatilpro.github.io/host/vstyle.css">
  <link rel="stylesheet" href="https://avipatilpro.github.io/host/v1style.css">
  <link rel="preconnect" href="https://fonts.gstatic.com">
...
.loading {
    ...
    .plyr__video-wrapper::before {
        ...
        height: 35px;
        width: 35px;
        background: url('https://www.voot.com/images/Voot-Logo.svg') no-repeat;
